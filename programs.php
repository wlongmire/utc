...
<div class="wrapper">
    ...
    <div style="float:right; display:inline;">
    	...
    	<table cellpadding="0" cellspacing="0" class="navTable">
            <tr>
                ...
                <td class="activeNav">Programs</td>
    ...
    <div style="padding-bottom: 10px; display: inline-block">
        <img src="images/programs/HaddingtonMapOval.png" align="left" width="80" style="padding-right:10px">
        <?php perch_content("top_content") ?>
    </div>

    <br />

    <?php perch_content("program_listing") ?>

    <hr color="#CCCCCC" size="1" width="100%" /><br />

    <div class="program_images">
        <?php perch_content("left_image") ?>
        <?php perch_content("right_image") ?>
    </div>
    <!-- <img src="images/programs/Memorial Garden.jpg" align="left" class="textImg margR7" height="325">
    <img src="images/programs/Adult Gardening Workshop.jpg" align="right" class="textImg margL7" height="325"> -->
...
<div class="footer">
    <span style="display:inline;">
        <a href="http://www.facebook.com/pages/Philadelphia-PA/Urban-Tree-Connection/296956299169">
            <img src="images/fb.png" height="20" border="0"/>
        </a>
        <a href="http://twitter.com/UTCphila"><img src="images/twitter.png" height="20" border="0"/></a>
